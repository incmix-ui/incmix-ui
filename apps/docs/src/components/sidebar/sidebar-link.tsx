...
const StyledLink = forwardRef(function StyledLink(props: PropsOf<typeof incmix.a> & { isActive?: boolean }, ref: Ref<any>) {
...
type SidebarLinkProps = PropsOf<typeof incmix.div> & {
  href?: string
