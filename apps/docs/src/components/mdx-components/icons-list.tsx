/* eslint-disable */
import * as icons from '@incmix-ui/icons'
import { Button, Grid, Text, useClipboard } from '@incmix-ui/react'
// import {useToast } from '@incmix-ui/react'
...
const IconsList = () => {
  ...
  return (
    <Grid mt={7} gap={5} templateColumns="repeat( auto-fit, minmax(150px, 1fr) )">
      {Object.keys(iconList).map((key, i) => {
        ...
        return (
          ...
          >
            <Icon />
            <Text as="span" mt={3} fontSize="sm" fontWeight="normal" textAlign="center">
              {key}
            </Text>
          </Button>
        )
