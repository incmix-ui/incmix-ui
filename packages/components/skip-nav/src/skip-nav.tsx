...
export interface SkipNavLinkProps
  extends HTMLIncmixProps<"a">,
    ThemingProps<"SkipNavLink"> {}

const fallbackId = "incmix-skip-nav"
 ...
 *
 * @see Docs https://incmix-ui.com/docs/components/skip-nav
 */
export const SkipNavLink = forwardRef<SkipNavLinkProps, "a">(
  function SkipNavLink(props, ref) {
    ...
    return (
      <incmix.a {...rest} ref={ref} href={`#${id}`} __css={getStyles(styles)} />
    )
  },
)
...
export interface SkipNavContentProps extends HTMLIncmixProps<"div"> {}
