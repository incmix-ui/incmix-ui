...
import type { PropGetter } from "@incmix-ui/react-types"
import { mergeRefs } from "@incmix-ui/react-use-merge-refs"
import { callAllHandlers, dataAttr } from "@incmix-ui/shared-utils"
import { omit } from "@incmix-ui/object-utils"
import { visuallyHiddenStyle } from "@incmix-ui/visually-hidden"
 ...
 *
 * @see Docs https://incmix-ui.com/checkbox#hooks
  ...
  const getRootProps: PropGetter = useCallback(
    (props = {}, forwardedRef = null) => ({
      ...
      onClick: callAllHandlers(props.onClick, () => {
         ...
         * @see Issue https://github.com/incmix-ui/incmix-ui/issues/3480
         */
