  ...
  expect(
    ...
    Object {
      "@media screen and (min-width: 30em)": Object {
        "color": "red",
        "fontSize": "var(--Incmix-fontSizes-4xl)",
        "marginTop": "var(--Incmix-space-4)",
      },
      "color": "blue",
      "fontSize": "var(--Incmix-fontSizes-2xl)",
      "fontWeight": "var(--Incmix-fontWeights-bold)",
      "marginTop": "var(--Incmix-space-3)",
    }
  `)
})
