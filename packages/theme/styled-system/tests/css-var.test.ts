...
test("should convert to css variables", () => {
  expect(
    ...
    Object {
      ...
      "__cssVars": Object {
        "--Incmix-ring-color": "rgba(66, 153, 225, 0.6)",
        "--Incmix-ring-inset": "var(--Incmix-empty,/*!*/ /*!*/)",
        "--Incmix-ring-offset-color": "#fff",
        "--Incmix-ring-offset-shadow": "0 0 #0000",
        "--Incmix-ring-offset-width": "0px",
        "--Incmix-ring-shadow": "0 0 #0000",
        "--Incmix-space-x-reverse": "0",
        "--Incmix-space-y-reverse": "0",
        "--space-lg": "24px",
        "--space-md": "16px",
        "--space-sm": "8px",
      },
  ...
  expect(toCSSVar(theme)).toMatchInlineSnapshot(`
    Object {
      ...
      "__cssVars": Object {
        ...
        ".incmix-ui-dark &:not([data-theme]),[data-theme=dark] &:not([data-theme]),&[data-theme=dark]": Object {
