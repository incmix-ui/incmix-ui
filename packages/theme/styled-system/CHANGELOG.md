...
- [#6221](https://github.com/incmix-ui/incmix-ui/pull/6221)
  ...
  ```jsx live=false
  import { defineStyleConfig, defineStyle } from "@incmix-ui/styled-system"
  ...
  ```jsx live=false
  import { createMultiStyleConfigHelpers } from "@incmix-ui/styled-sytem"
...
- [#5579](https://github.com/incmix-ui/incmix-ui/pull/5579)
  ...
  declaration merging in addition to allowing customization via the Incmix CLI.

  This makes it possible to do the following:

  - Distribute custom types with a component library based on Incmix
  ...
  type in a definitions file such as `types/Incmix.d.ts`:

  > ⚠️ NOTE: your `CustomThemeTypings` _must_ implement/extend
  > `BaseThemeTypings`, otherwise the types will fall back to the default Incmix
...
- [`1d4b1f874`](https://github.com/incmix-ui/incmix-ui/commit/1d4b1f87498c2d843cd21c24e86085d812a1de07)
  ...
  <Heading
    bgImage="linear-gradient(
      to right,
      var(--Incmix-colors-green-200)),
      var(--Incmix-colors-pink-500 calc(20px + 20px))"
  >
    incmix-ui: Create accessible React apps with speed
  </Heading>
  ```
...
- [`32e79f835`](https://github.com/incmix-ui/incmix-ui/commit/32e79f83545740e1df73e7ce689e4101646bb57d)
  ...
  ```jsx
  // We're convert `colors.red.200` to `var(--Incmix-colors-red-200)`
  <Box
    sx={{
...
- [`ff7c3676`](https://github.com/incmix-ui/incmix-ui/commit/ff7c36764650dc7f01957c417eae1ec8ce356495)
  ...
  **Note to maintainers**
  ...
  > color-mode styles.
  >
  > In Incmix v2, we'll only use JS to detect the initial color mode and rely on
