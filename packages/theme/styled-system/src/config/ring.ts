...
export const ring: Config = {
  ...
  ringColor: t.colors("--Incmix-ring-color"),
  ringOffset: t.prop("--Incmix-ring-offset-width"),
  ringOffsetColor: t.colors("--Incmix-ring-offset-color"),
  ringInset: t.prop("--Incmix-ring-inset"),
}
