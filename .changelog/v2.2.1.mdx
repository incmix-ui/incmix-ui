...
title: Version 2.2.1
description:
  Explore the changelog for Incmix UI version 2.2.1. Learn about the latest
  features, bug fixes, and improvements.
releaseUrl: https://github.com/incmix-ui/incmix-ui/pull/6163
...
- [#6159](https://github.com/incmix-ui/incmix-ui/pull/6159)
  ...
  `portalProps` in toast provider. When using with the `IncmixProvider`, this
...
## Incmix-nextjs-ts@2.0.7

### Patch Changes

- Updated dependencies

## @incmix-ui/test-utils@2.0.7
